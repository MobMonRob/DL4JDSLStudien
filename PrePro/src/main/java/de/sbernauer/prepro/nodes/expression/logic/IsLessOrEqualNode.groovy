...
public class IsLessOrEqualNode extends ExpressionNode {

    private ExpressionNode left;
    private ExpressionNode right;

    public IsLessOrEqualNode(ExpressionNode left, ExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public Variable execute(SymbolTable symbolTable, FunctionTable functionTable) {
        ...
        return leftValue.isLessOrEqualThan(rightValue);
    }
}
