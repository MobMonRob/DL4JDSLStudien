...
public class IsGreaterOrEqualNode extends ExpressionNode {

    private ExpressionNode left;
    private ExpressionNode right;

    public IsGreaterOrEqualNode(ExpressionNode left, ExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public Variable execute(SymbolTable symbolTable, FunctionTable functionTable) {
        ...
        return leftValue.isGreaterOrEqualThan(rightValue);
    }
}
